...
Note how each failure mode has a different beta and eta. Failure mode A (blue) has a beta less than 1, which may indicate infant mortality. Failure mode B (red) has a beta of approximately 1, which may indicate random failures. Failure mode C (orange) has a beta greater than 1, which may indicate wear out.
