...
```{r, echo=FALSE}
sliderInput("eta", "Eta:", min = 1, max = 10, value = 1, step = 0.1) # Slider for eta
...
Where $\beta$ is the shape parameter. In life data analysis $\beta$ has a physical interpretation related to the failure rate. The failure rate is the rate at which failures occur over time.
...
```{r, echo=FALSE}
sliderInput("beta", "Beta:", min = 0.5, max = 3, value = 1) # Slider for beta
plotOutput("cummPlot") # Plot output
```
