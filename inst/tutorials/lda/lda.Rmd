...
Note how each failure mode has a different beta and eta. Failure mode A (blue) has a beta less than 1, which means the failure rate is decreasing. Failure mode B (red) has a beta of approximately 1, which indicates a constant failure rate. Failure mode C (orange) has a beta greater than 1, which means that the failure rate is increasing.
