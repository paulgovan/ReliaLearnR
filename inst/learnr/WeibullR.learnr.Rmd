...
```{r beta, echo=FALSE}
question("Which beta below indicates a wear out failure mode?",
  answer("1"),
  answer("0.5"),
...
Note that the horizontal axis on a probability plot is log scale, and the vertical axis is log(log(1-p)) scale, where p=(i-0.3)/(n+4) and i is the rank of the observation. By using this scale, the resulting plot of the Weibull data appears linear. T

### Exercises

```{r unreliability, echo=FALSE}
question("What is the estimated unreliability at time 100?",
  answer("50%"),
  answer("20%"),
  answer("75%"),
...
```{r upper-confidence, echo=FALSE}
question("What is the upper 90% confidence level at time 50?",
