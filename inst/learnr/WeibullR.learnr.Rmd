...
question("What is the difference between obj1 and obj2?",
  answer("obj1 includes suspensions"),
  answer("obj2 includes suspensions"),
  answer("obj2 has a fit with a lower beta"),
  answer("Both 2 and 3 are true", correct = TRUE)
)
```
