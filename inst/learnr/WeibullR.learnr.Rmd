...
```{r b50, echo=FALSE}
question("What is the approximate P50 life (the time at which 50% of the machines are expected to fail?",
...
Let's rerun the competing failure mode example and build contour plots for each failure mode at a probability level of 90%.
