...
- Apply the Crow-AMSAA model and interpret its shape parameter $\beta$.
...
```{r}
plot(pred$times, pred$cum_failures, type = "l", col = "blue", lwd = 2,
     xlab = "Cumulative Time", ylab = "Cumulative Failures",
     main = "Crow-AMSAA Forecast (600–1000 hrs)",
     ylim = range(c(pred$lower_bounds, pred$upper_bounds)))
lines(pred$times, pred$lower_bounds, col = "blue", lty = 2)
lines(pred$times, pred$upper_bounds, col = "blue", lty = 2)
legend("topleft", legend = c("Forecast", "95% Bounds"),
