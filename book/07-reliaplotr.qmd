...
::: {.callout-note}
## HTML-Only Content
This chapter produces interactive **plotly** charts that require a web browser. In this PDF/EPUB version the code is shown without output. View the [online version](https://paulgovan.github.io/ReliaLearnR/) for the live interactive plots.
:::
:::
...
expobj <- alt.parallel(pwrobj, view_parallel_fits = FALSE)
