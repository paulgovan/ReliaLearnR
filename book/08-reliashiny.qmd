...
![ReliaShiny landing page showing the sidebar module list.](images/Landing.png){fig-alt="ReliaShiny web app with a left sidebar listing modules: Life Data Analysis, Reliability Growth, Accelerated Life Testing, and Repairable Systems."}
