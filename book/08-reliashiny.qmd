...
All of the analyses in this book require writing R code. **ReliaShiny** [@ReliaShiny] removes that requirement; it is a point-and-click Shiny [@shiny] web application that exposes the same reliability analysis workflows (life data analysis, reliability growth, accelerated life testing, repairable systems) through a graphical interface. No R programming knowledge is needed to run an analysis.
...
![ReliaShiny landing page showing the sidebar module list.](images/Landing.png){width=100% fig-alt="ReliaShiny web app with a left sidebar listing modules: Life Data Analysis, Reliability Growth, Accelerated Life Testing, and Repairable Systems."}
...
![LDA module showing a fitted Weibull probability plot.](images/ProbPlot.png){width=100% fig-alt="ReliaShiny Life Data Analysis module with a Weibull probability plot in the main panel and parameter estimates in the sidebar."}
...
![Reliability Growth module showing a fitted Crow-AMSAA cumulative failures plot.](images/GrowthPlot.png){width=100% fig-alt="ReliaShiny Reliability Growth module displaying a Crow-AMSAA cumulative failures plot with fitted model curve."}
...
![ALT module showing a probability plot and life-stress relationship.](images/ALTPlot.png){width=100% fig-alt="ReliaShiny Accelerated Life Testing module showing an ALT probability plot with stress-level curves and a life-stress relationship plot."}
...
![Repairable Systems module showing a Mean Cumulative Function plot.](images/RepairablePlot.png){width=100% fig-alt="ReliaShiny Repairable Systems module displaying an MCF cumulative failures curve with confidence bounds for a fleet of systems."}
