...
- **Complement, not replacement**: Quarto does not replace ReliaShiny (use ReliaShiny for point-and-click exploration) or AI + MCP (use MCP for conversational analysis), as each tool excels in a different context (see @sec-quarto-vs-tools).
