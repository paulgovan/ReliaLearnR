...
reliability testing, repairable systems analysis, reliability block diagrams, 
and reliability, availability, and maintainability (RAM) concepts. The package also 
includes helper functions for common RAM calculations.
...
The package includes five interactive learning modules. To launch the modules,
...
A static companion reference book is available alongside the interactive tutorials.
It covers the same material in a readable, searchable, and printable format, with
additional chapters on interactive visualization with
[ReliaPlotR](https://CRAN.R-project.org/package=ReliaPlotR) and the web-based app
[ReliaShiny](https://CRAN.R-project.org/package=ReliaShiny).

📖 **[Read the Companion Book](https://paulgovan.github.io/ReliaLearnR/book/)**

The book source lives in the `book/` directory of this repository and is rendered
